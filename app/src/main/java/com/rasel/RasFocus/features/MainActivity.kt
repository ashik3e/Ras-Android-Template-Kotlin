...
class MainActivity : ComponentActivity() {
    ...
    private fun checkPermissions() {
        ...
        if (!hasMediaPermission()) {
            showPopup(
                ...
                requestMediaPermission.launch(getMediaPermissions())
            }
            return
        }
        ...
        // All permissions granted — launch Compose UI
        openMainInterface()
    }
    ...
    private fun showPopup(title: String, message: String, onYes: () -> Unit) {
    ...
    private fun isAccessibilityEnabled(): Boolean {
        val expected = "$packageName/${packageName}.features.BlockerAccessibilityService"
